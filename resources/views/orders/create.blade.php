            ...
            <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <div class="form-group row">
                        ...
                        <select id="wine"
                                class="form-control @error('wine') is-invalid @enderror" name="wine" onchange="getComboA(this)">
                            <option value="">Please select...</option>
...
{{--                        </script>--}}
                        ...
                        <label for="quantity_wine" >Wine: Quantity</label>
                        <input id="quantity_wine" type="number"
                               ...
                               autocomplete="quantity_wine" autofocus placeholder="Insert quantity, e.g. 123">
